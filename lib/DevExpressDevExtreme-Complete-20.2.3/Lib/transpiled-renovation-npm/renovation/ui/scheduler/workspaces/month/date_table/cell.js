...
function MonthDateTableCell(props) {
  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var allDay = props.allDay,
        ...
        text = props.text,
        today = props.today,
        restProps = _objectWithoutProperties(props, ["allDay", "children", "className", "contentTemplate", "contentTemplateProps", "dataCellTemplate", "endDate", "groupIndex", "groups", "index", "isFirstGroupCell", "isLastGroupCell", "otherMonth", "startDate", "text", "today"]);

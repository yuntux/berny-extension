...
function AllDayPanelTableBody(props) {
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var className = props.className,
        ...
        isVerticalGroupOrientation = props.isVerticalGroupOrientation,
        viewData = props.viewData,
        restProps = _objectWithoutProperties(props, ["className", "dataCellTemplate", "isVerticalGroupOrientation", "viewData"]);

...
var baseTrackerPrototype = {
  ...
  updateSeries: function updateSeries(series, resetDecorations) {
    var that = this;
    var noHoveredSeries = !((series === null || series === void 0 ? void 0 : series.some(function (s) {
  ...
  _showTooltip: function _showTooltip(point) {
    ...
    if (point === null || point === void 0 ? void 0 : point.getOptions()) {
  ...
  _clickHandler: function _clickHandler(e) {
    ...
    if (that._legend.coordsIn(x, y)) {
    ...
    } else if (axis === null || axis === void 0 ? void 0 : axis.coordsIn(x, y)) {
      ...
      if ((_point3 = point) === null || _point3 === void 0 ? void 0 : _point3.getMarkerVisibility()) {
...
(0, _extend.extend)(ChartTracker.prototype, baseTrackerPrototype, {
  ...
  _moveCrosshair: function _moveCrosshair(point, x, y) {
    if (this._crosshair && (point === null || point === void 0 ? void 0 : point.isVisible())) {

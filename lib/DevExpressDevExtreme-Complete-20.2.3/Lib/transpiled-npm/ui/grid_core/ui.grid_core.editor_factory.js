...
var EditorFactory = _uiGrid_core.default.ViewController.inherit({
  _getFocusedElement: function _getFocusedElement($dataGridElement) {
    ...
    var focusedElementSelector = "td[tabindex]:focus, ".concat(rowSelector, ", input:focus, textarea:focus, .dx-lookup-field:focus, .dx-checkbox:focus, .dx-switch:focus"); // T181706

...
var Export = {
  ...
  tryGetMergeRange: function tryGetMergeRange(rowIndex, cellIndex, mergedCells, dataProvider) {
  ...
  mergeCells: function mergeCells(worksheet, topLeftCell, mergeRanges) {
  ...
  setLoadPanelOptions: function setLoadPanelOptions(component, options, privateOptions) {
  ...
  export: function _export(options, privateOptions) {
    var _this = this;
  ...
  exportRow: function exportRow(rowIndex, cellCount, row, startColumnIndex, dataProvider, customizeCell, headerRowCount, mergedCells, mergeRanges, wrapText, privateOptions) {

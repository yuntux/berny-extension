...
var TooltipItemLayout = /*#__PURE__*/function (_BaseComponent) {
  _inherits(TooltipItemLayout, _BaseComponent);

  var _super = _createSuper(TooltipItemLayout);

  function TooltipItemLayout() {
    _classCallCheck(this, TooltipItemLayout);
  ...
  _createClass(TooltipItemLayout, [{
    ...
    value: function getProps() {
      var props = _get(_getPrototypeOf(TooltipItemLayout.prototype), "getProps", this).call(this);

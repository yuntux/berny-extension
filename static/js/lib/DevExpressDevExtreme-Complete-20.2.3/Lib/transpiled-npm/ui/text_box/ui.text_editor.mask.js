...
var TextEditorMask = _uiText_editor.default.inherit({
  ...
  _renderValue: function _renderValue() {
    if (this._maskRulesChain) {
      ...
      if (this._$hiddenElement) {
        ...
        this._$hiddenElement.val(!(0, _string.isEmpty)(value) ? hiddenElementValue : '');
      }
    }
  ...
  _isControlKeyFired: function _isControlKeyFired(e) {
    return this._isControlKey((0, _index.normalizeKeyName)(e)) || e.ctrlKey // NOTE: FF fires control keys on keypress

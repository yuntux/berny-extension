...
var Drawer = _ui.default.inherit({
  ...
  _render: function _render() {
    ...
    this._whenPanelContentRendered.always(function () {
      ...
      if (_this._$panelContentWrapper.attr('manualposition')) {
        _this._$panelContentWrapper.removeAttr('manualPosition');

        _this._$panelContentWrapper.css({
          position: '',
          top: '',
          left: '',
          right: '',
  ...
  _renderPosition: function _renderPosition(isDrawerOpened, animate, jumpToEnd) {

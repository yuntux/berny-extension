  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    ...
    var _props$value$rootElem = _objectSpread(_objectSpread({}, props), {}, {
      ...
      rootElementRef: (_props$rootElementRef = props.rootElementRef) === null || _props$rootElementRef === void 0 ? void 0 : _props$rootElementRef.current
        ...
        invalidValueMessage = _props$value$rootElem.invalidValueMessage,
        max = _props$value$rootElem.max,
        min = _props$value$rootElem.min,
        mode = _props$value$rootElem.mode,
        ...
        showSpinButtons = _props$value$rootElem.showSpinButtons,
        step = _props$value$rootElem.step,
        tabIndex = _props$value$rootElem.tabIndex,
        useLargeSpinButtons = _props$value$rootElem.useLargeSpinButtons,

...
function DateTableCellBase(props) {
  ...
  var __dataCellTemplateProps = (0, _hooks.useCallback)(function __dataCellTemplateProps() {
    var allDay = props.allDay,
  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var allDay = props.allDay,
        ...
        startDate = props.startDate,
        text = props.text,
        restProps = _objectWithoutProperties(props, ["allDay", "children", "className", "contentTemplate", "contentTemplateProps", "dataCellTemplate", "endDate", "groupIndex", "groups", "index", "isFirstGroupCell", "isLastGroupCell", "startDate", "text"]);

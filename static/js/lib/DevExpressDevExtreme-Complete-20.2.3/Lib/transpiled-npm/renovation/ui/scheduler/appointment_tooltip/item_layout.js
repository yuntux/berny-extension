...
function TooltipItemLayout(props) {
  var __currentAppointment = (0, _hooks.useCallback)(function __currentAppointment() {
    var item = props.item;
    return (0, _get_current_appointment.default)(item);
  }, [props.item]);

  var __onDeleteButtonClick = (0, _hooks.useCallback)(function __onDeleteButtonClick() {
    var item = props.item,
  ...
  var __formattedContent = (0, _hooks.useCallback)(function __formattedContent() {
  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var className = props.className,
        ...
        singleAppointment = props.singleAppointment,
        restProps = _objectWithoutProperties(props, ["className", "getTextAndFormatDate", "index", "item", "itemContentTemplate", "onDelete", "onHide", "showDeleteButton", "singleAppointment"]);

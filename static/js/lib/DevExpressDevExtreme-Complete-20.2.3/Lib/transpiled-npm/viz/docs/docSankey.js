...
var dxSankey = (_dxSankey = {
  ...
  sortData: undefined,
  sourceField: 'source'
}, _defineProperty(_dxSankey, "sourceField", 'target'), _defineProperty(_dxSankey, "weightField", 'weight'), _defineProperty(_dxSankey, "label", {
  /**
...
}), _defineProperty(_dxSankey, "link", {
  /**
...
}), _defineProperty(_dxSankey, "onNodeClick", function onNodeClick() {}), _defineProperty(_dxSankey, "onLinkClick", function onLinkClick() {}), _defineProperty(_dxSankey, "onNodeHoverChanged", function onNodeHoverChanged() {}), _defineProperty(_dxSankey, "onLinkHoverChanged", function onLinkHoverChanged() {}), _defineProperty(_dxSankey, "getAllNodes", function getAllNodes() {}), _defineProperty(_dxSankey, "getAllLinks", function getAllLinks() {}), _defineProperty(_dxSankey, "hideTooltip", function hideTooltip() {}), _dxSankey);
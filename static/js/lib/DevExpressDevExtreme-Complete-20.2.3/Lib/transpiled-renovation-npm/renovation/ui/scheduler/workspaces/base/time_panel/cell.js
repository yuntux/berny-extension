...
function TimePanelCell(props) {
  var __timeCellTemplateProps = (0, _hooks.useCallback)(function __timeCellTemplateProps() {
  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var allDay = props.allDay,
        ...
        restProps = _objectWithoutProperties(props, ["allDay", "children", "className", "contentTemplate", "contentTemplateProps", "endDate", "groupIndex", "groups", "index", "isFirstGroupCell", "isLastGroupCell", "startDate", "text", "timeCellTemplate"]);

...
var BaseWidget = {
  ...
  */
  ...
  redrawOnResize: true,
  disabled: false,
  onIncidentOccurred: function onIncidentOccurred() {},
  svg: function svg() {},
  ...
  */
  ...
  'export': {
    ...
    margin: 10,
    svgToCanvas: function svgToCanvas(svg, canvas) {}
  },
  onExporting: function onExporting() {},
  onExported: function onExported() {},
  onFileSaving: function onFileSaving() {},
  tooltip: {
    enabled: false,
    format: undefined,
    color: '#ffffff',
...
var BaseWidgetAnnotationConfig = {
  type: undefined,
  x: undefined,
  y: undefined,
  offsetX: undefined,

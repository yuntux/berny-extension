...
var dxVectorMap = (_dxVectorMap = {
  ...
  */
  ...
  onZoomFactorChanged: function onZoomFactorChanged() {},
  onSelectionChanged: function onSelectionChanged() {},
  getLayers: function getLayers() {},
  getLayerByIndex: function getLayerByIndex() {},
  getLayerByName: function getLayerByName() {},
  clearSelection: function clearSelection() {}
}, _defineProperty(_dxVectorMap, "center", function center() {}), _defineProperty(_dxVectorMap, "center", function center() {}), _defineProperty(_dxVectorMap, "zoomFactor", function zoomFactor() {}), _defineProperty(_dxVectorMap, "zoomFactor", function zoomFactor() {}), _defineProperty(_dxVectorMap, "viewport", function viewport() {}), _defineProperty(_dxVectorMap, "viewport", function viewport() {}), _defineProperty(_dxVectorMap, "convertCoordinates", function convertCoordinates() {}), _defineProperty(_dxVectorMap, "convertToGeo", function convertToGeo() {}), _defineProperty(_dxVectorMap, "convertToXY", function convertToXY() {}), _defineProperty(_dxVectorMap, "commonAnnotationSettings", undefined), _defineProperty(_dxVectorMap, "annotations", [{}]), _defineProperty(_dxVectorMap, "customizeAnnotation", undefined), _dxVectorMap);
/**
...
var dxVectorMapCommonAnnotationConfig = {
...
var dxVectorMapAnnotationConfig = {
  name: undefined
};
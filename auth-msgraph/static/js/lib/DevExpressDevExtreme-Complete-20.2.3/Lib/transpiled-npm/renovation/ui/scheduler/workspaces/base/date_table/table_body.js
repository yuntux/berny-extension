...
var viewFunction = function viewFunction(viewModel) {
  return Preact.h(Preact.Fragment, null, viewModel.props.viewData.groupedData.map(function (_ref, groupIndex) {
    var allDayPanel = _ref.allDayPanel,
        dateTable = _ref.dateTable;
    return Preact.h(Preact.Fragment, {
      key: (0, _utils.getKeyByGroup)(groupIndex)
    }, (0, _utils.getIsGroupedAllDayPanel)(viewModel.props.viewData, groupIndex) && Preact.h(_table_body.AllDayPanelTableBody, {
      ...
      return Preact.h(_row.Row, {
        ...
        key: cellsRow[0].key
      }, cellsRow.map(function (_ref2) {
        var endDate = _ref2.endDate,
            cellGroupIndex = _ref2.groupIndex,
            groups = _ref2.groups,
            index = _ref2.index,
        ...
        return Preact.h(viewModel.cell, {

...
var WeekTableLayout = /*#__PURE__*/function (_BaseComponent) {
  _inherits(WeekTableLayout, _BaseComponent);

  var _super = _createSuper(WeekTableLayout);

  function WeekTableLayout() {
    _classCallCheck(this, WeekTableLayout);
  ...
  _createClass(WeekTableLayout, [{
    ...
    value: function getProps() {
      var props = _get(_getPrototypeOf(WeekTableLayout.prototype), "getProps", this).call(this);

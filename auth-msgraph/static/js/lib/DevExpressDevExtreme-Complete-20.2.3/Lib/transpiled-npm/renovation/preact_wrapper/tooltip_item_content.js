...
var TooltipItemContent = /*#__PURE__*/function (_Component) {
  _inherits(TooltipItemContent, _Component);

  var _super = _createSuper(TooltipItemContent);

  function TooltipItemContent() {
    _classCallCheck(this, TooltipItemContent);
  ...
  _createClass(TooltipItemContent, [{
    ...
    value: function _setOptionsByReference() {
      _get(_getPrototypeOf(TooltipItemContent.prototype), "_setOptionsByReference", this).call(this);

...
var TagBox = _select_box.default.inherit({
  ...
  _getBorderPosition: function _getBorderPosition(direction) {
    ...
    var isScrollReverted = rtlEnabled && !_browser.default.webkit;
    var scrollSign = !rtlEnabled || _browser.default.webkit || _browser.default.msie ? 1 : -1;
  ...
  _getFocusedTagPosition: function _getFocusedTagPosition(direction) {
    ...
    if (isScrollLeft ^ scrollOffset < 0) {
      var scrollCorrection = rtlEnabled && _browser.default.msie ? -1 : 1;
  ...
  _initMarkup: function _initMarkup() {
    ...
    this.$element().addClass(TAGBOX_CLASS).toggleClass(TAGBOX_ONLY_SELECT_CLASS, !(this.option('searchEnabled') || this.option('acceptCustomValue'))).toggleClass(TAGBOX_SINGLE_LINE_CLASS, isSingleLineMode); // TODO: texteditor render methods order research
  ...
  _tagContainerMouseWheelHandler: function _tagContainerMouseWheelHandler(e) {
    ...
    if ((0, _utils3.allowScroll)(this._$tagsContainer, delta, true)) {
  ...
  _refreshSelected: function _refreshSelected() {
    ...
    ((_this$_list = this._list) === null || _this$_list === void 0 ? void 0 : _this$_list.getDataSource()) && this._list.option('selectedItems', this._selectedItems);
  },

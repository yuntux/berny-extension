...
var android4_0nativeBrowser = realDevice.platform === 'android' && (0, _version.compare)(realVersion, [4, 0], 2) === 0 && navigator.userAgent.indexOf('Chrome') === -1;
...
var Overlay = _ui.default.inherit({
  ...
  _defaultOptionsRules: function _defaultOptionsRules() {
    return this.callBase().concat([{
      device: function device() {
        ...
        var realVersion = realDevice.version;
        return realPlatform === 'android' && (0, _version.compare)(realVersion, [4, 2]) < 0;
      },
      options: {
        animation: {
          show: {
  ...
  _renderPosition: function _renderPosition() {
    if (this._positionChangeHandled) {
      ...
      forceRepaint(this._$content); // TODO: hotfix for T338096

  ...
  */
  ctor: function ctor(options) {
    ...
    */
    ...
    var onPushHandler = options.pushAggregationTimeout !== 0 ? _utils.default.throttleChanges(this._onPush, function () {
      return options.pushAggregationTimeout === undefined ? _this._changedTime * 5 : options.pushAggregationTimeout;
    }) : this._onPush;
    this._changedTime = 0;

...
var DayDateTableLayout = /*#__PURE__*/function (_BaseComponent) {
  _inherits(DayDateTableLayout, _BaseComponent);

  var _super = _createSuper(DayDateTableLayout);

  function DayDateTableLayout() {
    _classCallCheck(this, DayDateTableLayout);
  ...
  _createClass(DayDateTableLayout, [{
    ...
    value: function getProps() {
      var props = _get(_getPrototypeOf(DayDateTableLayout.prototype), "getProps", this).call(this);

...
function PagesLarge(props) {
  ...
  var __slidingWindowState = (0, _hooks.useCallback)(function __slidingWindowState() {
  ...
  var __canReuseSlidingWindow = (0, _hooks.useCallback)(function __canReuseSlidingWindow(currentPageCount, pageIndex) {
  ...
  var __generatePageIndexes = (0, _hooks.useCallback)(function __generatePageIndexes() {
    ...
    if ((props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex) === slidingWindowIndexes[0]) {
      startIndex = (props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex) - 1;
    } else if ((props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex) === slidingWindowIndexes[slidingWindowIndexes.length - 1]) {
      startIndex = (props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex) + 2 - PAGES_LIMITER;
    } else if ((props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex) < PAGES_LIMITER) {
      startIndex = 1;
    } else if ((props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex) >= pageCount - PAGES_LIMITER) {
  ...
  var __isSlidingWindowMode = (0, _hooks.useCallback)(function __isSlidingWindowMode() {
  ...
  var __onPageClick = (0, _hooks.useCallback)(function __onPageClick(pageIndex) {
  ...
  var __pageIndexes = (0, _hooks.useCallback)(function __pageIndexes() {
    var pageCount = props.pageCount;
    ...
    if (__canReuseSlidingWindow(pageCount, props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex)) {
  ...
  var __pages = (0, _hooks.useCallback)(function __pages() {
    var createPage = function createPage(index) {
      var pagerProps = index === "low" || index === "high" ? null : {
        ...
        selected: (props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex) === index
      };
      return {
        key: index.toString(),
    ...
    var rtlPageIndexes = (config === null || config === void 0 ? void 0 : config.rtlEnabled) ? _toConsumableArray(__pageIndexes()).reverse() : __pageIndexes();
  ...
  var __restAttributes = (0, _hooks.useCallback)(function __restAttributes() {
    var _props$pageIndex = _objectSpread(_objectSpread({}, props), {}, {
      pageIndex: props.pageIndex !== undefined ? props.pageIndex : __state_pageIndex
        ...
        restProps = _objectWithoutProperties(_props$pageIndex, ["defaultPageIndex", "maxPagesCount", "pageCount", "pageIndex", "pageIndexChange"]);

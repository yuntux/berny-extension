...
var _BaseGauge, _dxBarGauge;

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

var BaseGauge = (_BaseGauge = {
  ...
  value: undefined,
  subvalues: undefined
}, _defineProperty(_BaseGauge, "value", function value() {}), _defineProperty(_BaseGauge, "value", function value() {}), _defineProperty(_BaseGauge, "subvalues", function subvalues() {}), _defineProperty(_BaseGauge, "subvalues", function subvalues() {}), _BaseGauge);
var dxCircularGauge = {
  geometry: {
    /**
...
var dxBarGauge = (_dxBarGauge = {
  ...
  baseValue: 0,
  values: []
}, _defineProperty(_dxBarGauge, "values", function values() {}), _defineProperty(_dxBarGauge, "values", function values() {}), _defineProperty(_dxBarGauge, "onTooltipShown", function onTooltipShown() {}), _defineProperty(_dxBarGauge, "onTooltipHidden", function onTooltipHidden() {}), _dxBarGauge);
/**

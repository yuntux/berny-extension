...
var Slider = _track_bar.default.inherit({
  ...
  _renderStartHandler: function _renderStartHandler() {
    ...
    _events_engine.default.on($element, clickEventName, function (e) {
      var $handle = _this._activeHandle();
  ...
  _valueStep: function _valueStep(step) {
    ...
    step = parseFloat(step.toFixed(5)); // TODO or exception?
  ...
  _optionChanged: function _optionChanged(args) {
    switch (args.name) {
      case 'visible':
        ...
        (0, _visibility_change.triggerShownEvent)(this.$element()); // TODO: move firing dxshown event to Widget

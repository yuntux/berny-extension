...
var ValidatingController = _uiGrid_core.default.Controller.inherit(function () {
  return {
    ...
    _rowIsValidated: function _rowIsValidated(editData) {
      var validationData = this._getValidationData(editData === null || editData === void 0 ? void 0 : editData.key);
    ...
    _rowValidating: function _rowValidating(validationData, validationResults) {
      ...
      var editData = this._editingController.getEditDataByKey(validationData === null || validationData === void 0 ? void 0 : validationData.key);
    ...
    isRowDataModified: function isRowDataModified(editData) {
      return !(0, _type.isEmptyObject)(editData.data);
    },
    updateValidationState: function updateValidationState(editData) {
    ...
    validatorDisposing: function validatorDisposing(arg) {
      ...
      var result = this.getCellValidationResult({
        rowKey: editData === null || editData === void 0 ? void 0 : editData.key,
        columnIndex: column.index
      });
    ...
    createValidator: function createValidator(parameters, $container) {
      ...
      if (needCreateValidator) {
        ...
        var getValue = function getValue() {
          var editData = editingController.getEditDataByKey(validationData === null || validationData === void 0 ? void 0 : validationData.key);
          var value = column.calculateCellValue((editData === null || editData === void 0 ? void 0 : editData.data) || {});
        ...
        var validator = new _validator.default($container || (0, _renderer.default)('<div>'), {
          ...
          dataGetter: function dataGetter() {
            ...
            return {
              data: (0, _array_utils.createObjectWithChanges)(oldData, editData === null || editData === void 0 ? void 0 : editData.data),
              column: column
            };
          },
    ...
    isCurrentValidatorProcessing: function isCurrentValidatorProcessing(_ref) {
    ...
    updateCellValidationResult: function updateCellValidationResult(_ref2) {
    ...
    getCellValidationResult: function getCellValidationResult(_ref3) {
    ...
    removeCellValidationResult: function removeCellValidationResult(_ref4) {
    ...
    cancelCellValidationResult: function cancelCellValidationResult(_ref5) {
    ...
    isInvalidCell: function isInvalidCell(_ref6) {
    ...
    getCellValidator: function getCellValidator(_ref7) {
    ...
    controllers: {
      editing: {
        ...
        _updateEditRowCore: function _updateEditRowCore(row, skipCurrentRow, isCustomSetCellValue) {
          this.callBase.apply(this, arguments); // T816256, T844143
        ...
        _needInsertItem: function _needInsertItem(editData) {
          ...
          if (result && !(validationData === null || validationData === void 0 ? void 0 : validationData.isValid)) {
        ...
        processItems: function processItems(items, changeType) {
          ...
          var addInValidItem = function addInValidItem(editData, validationData) {
            var data = {
              key: editData.key
            };
        ...
        _beforeSaveEditData: function _beforeSaveEditData(editData, editIndex) {
          ...
          var validationData = validatingController._getValidationData(editData === null || editData === void 0 ? void 0 : editData.key);

          if (editData) {
            var isValid = editData.type === 'remove' || validationData.isValid;
      ...
      editorFactory: function () {
        ...
        return {
          ...
          updateCellState: function updateCellState($element, validationResult, hideBorder) {
            ...
            if (validationResult && validationResult.status === VALIDATION_STATUS.invalid || editData && editData.type === 'update' && !this._editingController.isSaving()) {
              if (this._editingController.getEditMode() === EDIT_MODE_CELL) {
